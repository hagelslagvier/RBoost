...
# Form implementation generated from reading ui file 'Ui_BaseDialogItem.ui'
#
...
class Ui_BaseDialogItem(object):
    def setupUi(self, BaseDialogItem):
        BaseDialogItem.setObjectName("BaseDialogItem")
        BaseDialogItem.resize(719, 451)
        self.gridLayout_2 = QtWidgets.QGridLayout(BaseDialogItem)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.labelExpression = QtWidgets.QLabel(BaseDialogItem)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.textEditExpression = QtWidgets.QTextEdit(BaseDialogItem)
        ...
        self.labelMeaning = QtWidgets.QLabel(BaseDialogItem)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.textEditMeaning = QtWidgets.QTextEdit(BaseDialogItem)
        ...
        self.labelAlphaber = QtWidgets.QLabel(BaseDialogItem)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.widgetAlphabet = QtWidgets.QWidget(BaseDialogItem)
        ...
        self.gridLayout.addLayout(self.verticalLayout_11, 0, 7, 1, 1)
        ...
        self.pushButtonCancel = QtWidgets.QPushButton(BaseDialogItem)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.retranslateUi(BaseDialogItem)
        QtCore.QMetaObject.connectSlotsByName(BaseDialogItem)

    def retranslateUi(self, BaseDialogItem):
        _translate = QtCore.QCoreApplication.translate
        self.labelExpression.setText(_translate("BaseDialogItem", "Выражение:"))
        self.labelMeaning.setText(_translate("BaseDialogItem", "Значение:"))
        self.labelAlphaber.setText(_translate("BaseDialogItem", "Алфавит:"))
        self.pushButton_11.setText(_translate("BaseDialogItem", "É"))
        self.pushButton_12.setText(_translate("BaseDialogItem", "é"))
        self.pushButton_13.setText(_translate("BaseDialogItem", "Ü"))
        self.pushButton_14.setText(_translate("BaseDialogItem", "ü"))
        self.pushButton_09.setText(_translate("BaseDialogItem", "Ø"))
        self.pushButton_10.setText(_translate("BaseDialogItem", "ø"))
        self.pushButton_05.setText(_translate("BaseDialogItem", "Æ"))
        self.pushButton_06.setText(_translate("BaseDialogItem", "æ"))
        self.pushButton_03.setText(_translate("BaseDialogItem", "Å"))
        self.pushButton_04.setText(_translate("BaseDialogItem", "å"))
        self.pushButton_01.setText(_translate("BaseDialogItem", "Ä"))
        self.pushButton_02.setText(_translate("BaseDialogItem", "ä"))
        self.pushButton_07.setText(_translate("BaseDialogItem", "Ö"))
        self.pushButton_08.setText(_translate("BaseDialogItem", "ö"))
